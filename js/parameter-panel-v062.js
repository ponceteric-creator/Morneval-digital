...
/*
 * v0.6.2 mobile stability fix:
 * The old observer watched the entire #app subtree. Every full UI redraw and
 * every injected panel mutation could schedule another subtree callback on
 * mobile Safari. We only need to know when the root's main child is replaced.
 * Observe direct children only, and defer injection to the next animation
 * frame so a field's change event can finish before DOM is extended.
 */
